...
%     close all
    ...
    % Cell center
    CellCenter = AllGoodCells{1}(i_cell, 5:6);    % X and Y of cell center at the initial time point
...
%% to initial cell center (used then for assembling the kymo (as reference for the opening point))
    Cont = AllContours{i_cell, 1};    % Y and X of the contour
...
%% Visualise and save kymographs 
    ...
    Start = Add1 - 250;        % X coordinate of the beginning of the last line of the kymograph
    End = Add1 + ProfLenShort + 250;
