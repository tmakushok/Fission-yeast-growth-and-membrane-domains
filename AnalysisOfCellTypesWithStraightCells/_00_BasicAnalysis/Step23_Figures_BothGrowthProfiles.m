...
DivisionsFile = '_Output/_DivisionStartAndEnd.mat';
...
for i_cell = 29:29  % 1:length(TipsLen)       % Loop on cells
    i_cell
%     pause(0.1);
    close all;
...
%         subplot(2,1,i_end);
    ...
    print('-dtiff', '-r500', ['_Output/_BothGrowthProfiles_Cell_' int2str(i_cell) '_Cropped']);
end
